...
export type SchematicNode = DeviceNode | RoomNode | NoteNode | AnnotationNode | ImageNode | StubLabelNode | WaypointNode | BundleJunctionNode;
...
export type SchematicPage = RackElevationPage | PrintSheetPage | FloorplanPage;
